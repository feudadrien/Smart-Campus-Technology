...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    [ESTConfig setupAppID:@"ios-s-objective-c-notifica-ac6" andAppToken:@"6e25abf1859d96ec14f570e79b3e2891"];
    ...
    [self.beaconNotificationsManager enableNotificationsForBeaconID:
     //[[BeaconID alloc] initWithUUIDString:@"B9407F30-F5F8-466E-AFF9-25556B57FE6D" major:22158 minor:33992]
     [[BeaconID alloc] initWithUUIDString:@"C9407F30-F5F8-466E-AFF9-25556B57FE6D" major:179 minor:3]
     enterMessage:@"Welcome to the Engineering Building!"
     exitMessage:@"Goodbye :)"
     ];
